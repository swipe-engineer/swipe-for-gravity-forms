...
Accept credit card, online banking and e-wallet directly on your store with the Swipe payment gateway for Gravity Forms.
...
Swipe for Gravity Forms includes Web Payments API support, allowing customers to pay using payment information associated with their mobile devices in browsers that support the Web Payments API (Chrome for Android, amongst others). On mobile, checkout is now just a few taps away.
...
#### GET STARTED SWIPE FOR Gravity Forms

Step for existing Swipe users:
1. Install and activate your Gravity Forms.
...
How to use Gravity Forms plugin with Swipe:
1. Install and activate your Gravity Forms.
   Notes: You do not have to configure Swipe at Gravity Forms, we have configured everything.
